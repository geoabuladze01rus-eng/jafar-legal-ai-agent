...
private struct MattersOverviewView: View { var body: some View { JafarCard(title: "Мои дела") { Text("Дела пока не загружены").foregroundStyle(JafarPalette.secondary) } } }
