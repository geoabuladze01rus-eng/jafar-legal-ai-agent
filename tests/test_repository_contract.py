...
def test_record_document_event_is_atomic_at_repository_boundary():
    ...
    deadline = Deadline(title="Обжалование", due_date=datetime(2026, 8, 21, tzinfo=UTC), source_text="срок")
    event = repo.record_document_event("matter-1", "Анализ документа", datetime.now(UTC),
