...
struct ContentView: View {
    ...
    var body: some View {
        NavigationSplitView { sidebar } detail: { selected == "Главная" ? AnyView(dashboard) : AnyView(JafarComingSoonView(title: selected)) }
