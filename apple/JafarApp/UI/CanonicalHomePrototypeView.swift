...
private struct CanonicalPanel<Content: View>: View {
    ...
    init(glow: Color = .clear, @ViewBuilder content: () -> Content) {
        self.glow = glow
        ...
        content
            ...
            .background {
                RoundedRectangle(cornerRadius: 8, style: .continuous)
                    ...
                    .overlay(RoundedRectangle(cornerRadius: 8).fill(glow.opacity(glow == .clear ? 0 : 0.07)))
            }
    }
}
